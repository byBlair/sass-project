...
var section01 = false;
function btn01() {
  var Width = (0, _jquery.default)('.box02').width();
  (0, _jquery.default)('.next').on('click', function () {
    if (section01) return;
    (0, _jquery.default)('.box02>div').animate({
      marginLeft: '-=' + Width + 'px'
    }, function () {
      (0, _jquery.default)('box02>div').css('margin-left', '-' + Width + 'px');
    });
    section01 = !section01;
  });
}
function btn02() {
  var Width = (0, _jquery.default)('.box02').width();
  (0, _jquery.default)('.prev').on('click', function () {
    if (!section01) return;
    (0, _jquery.default)('.box02>div').animate({
      marginLeft: '+=' + Width + 'px'
    }, function () {
